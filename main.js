...
var LogService = /** @class */ (function () {
    function LogService() {
        /*     this.logs = [
              ...
              {id: '3', text: 'Added logs component', date: new Date('12/27/2017 12:00:13')}
            ]; */
    ...
    LogService.prototype.addLog = function (log) {
        this.logs.unshift(log); // put at beginning of array
        // add to local storage (needs to be a string)
    ...
    LogService.prototype.updateLog = function (log) {
        ...
        this.logs.forEach(function (cur, index) {
            if (log.id === cur.id) {
                _this.logs.splice(index, 1); // removes log
            }
        });
        this.logs.unshift(log); // add updated log to beginning of array
...
module.exports = __webpack_require__(/*! /Users/gord/Developer/angular-workspace/projects/brad-traversy/devlogger/src/main.ts */"./src/main.ts");
